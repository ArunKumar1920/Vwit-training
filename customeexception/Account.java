...
public class Account {
	...
	public double withdraw(double amt) throws InsufficientBalanceException, ZeroBalance
	{
		if(amt <= this.balance )
		{
			this.balance = this.balance - amt;
		...
		{
			throw new ZeroBalance(this.balance,amt,this.acctNo);
		}
		else
		{
	...
	private void elseif(double balance2) {
